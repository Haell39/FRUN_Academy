<?php
// F-RUM-ACADEMIA/Pagina-de-posts/posts.php
...
<head>
    ...
    <link rel="stylesheet" href="/F-RUM-ACADEMIA/Pagina-de-posts/posts.css" />
</head>
                ...
                foreach ($posts as $post) {
                    ...
                    <div class="post-preview-card" id="post-preview-<?php echo htmlspecialchars($post->id); ?>">
                        <div class="card-header">
                            <img src="/F-RUM-ACADEMIA/img/Imagens-Blog-Lund-Trainers-768x512 (1).png" alt="" width="100">
                            <div class="card-info">
...
<script src="/F-RUM-ACADEMIA/Pagina-de-posts/posts.js"></script>
</body>
